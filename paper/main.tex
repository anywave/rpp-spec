...
% License: CC BY 4.0
%
% ⚠️ DEPRECATION NOTICE (v2.0): This paper describes the legacy 28-bit format.
...
% This paper will be updated for v2.0 in a future revision.
...
\date{January 2026\\Version 1.1.0 (Legacy 28-bit)\\
\textcolor{red}{\small See spec/RPP-CANONICAL-v2.md for Ra-Canonical v2.0 (32-bit)}}
