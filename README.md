...
**RPP is a deterministic semantic addressing and routing layer that reduces duplicated decision logic across systems.**
...
[![DOI](https://zenodo.org/badge/1123781333.svg)](https://doi.org/10.5281/zenodo.18072438)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](LICENSE)
[![Spec Version](https://img.shields.io/badge/Spec-v1.0.0-green.svg)](spec/SPEC.md)
[![Python 3.9+](https://img.shields.io/badge/python-3.9+-blue.svg)](https://www.python.org/downloads/)

> **Core Stable (v0.1.x):** The 28-bit address format is frozen. Only non-breaking additions permitted.
>
